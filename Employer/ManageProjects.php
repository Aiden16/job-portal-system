    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <div class="article">
                ...
                <h2><span><a href="ProjectApplications.php">Applications</a></span></h2>


                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td bgcolor="#A0B9F3"><strong>Manage Projects</strong></td>
                  </tr>
                  <tr>
                    <td><form id="form1" method="post" action="InsertProject.php">
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                        ...
                        <tr>
                          <td><strong>Pay Range:</strong></td>
                          <td><label>
                            <input type="text" name="txtPay" id="txtOther" />
                          </label></td>
                        </tr>
                        <tr>
