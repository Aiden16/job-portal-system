...
// Specify the query to execute
$sql = "select * from Academics where JobSeekId='".$ID."'";
// Execute query
$result = mysqli_query($con,$sql);
// Loop through each records
...
?>
                      <tr>
                        ...
                        <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $Highschool ;?></strong></div></td>
                        <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $Per;?></strong></div></td>
                        <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $cgpa;?></strong></div></td>
