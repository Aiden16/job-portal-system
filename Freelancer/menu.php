<!-- Main menu (tabs) -->
     <div id="tabs" class="noprint">
            ...
            <ul class="box">
                ...
                <li><a href="SearchProjects.php">Search Projects<span class="tab-l"></span><span class="tab-r"></span></a></li>
                <li><a href="hiredBy.php">Hired by<span class="tab-l"></span><span class="tab-r"></span></a></li>
