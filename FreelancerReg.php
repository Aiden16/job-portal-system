...
<!-- Page (2 columns) -->
    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <!-- Article -->
            <div class="article">
                <h2><span><a href="#">Freelancer Registration Form</a></span></h2>


                    <div class="login">

                <form action="FreelancerInsert.php" method="post" onSubmit="return validateForm(this,arrFormValidation);" enctype="multipart/form-data" id="form2">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td>Skills:</td>
                      <td><label>
                          <input type="text" name="txtSkills" id="txtQualification" />
                      </label>
					  <span class="textfieldRequiredMsg">Enter Skills</span></td>
                    </tr>
                    <tr>
                    <tr>
                      <td>Mobile:</td>
